...
@Service
public class CustomerRegistrationService2 {
	...
	@Transactional
	public boolean saveOrUpdateBCSystem2(CustomerRegistrationBean register) {
	    logger.debug("In CustomerRegistrationService2 : Saving Customer information " + register.getCust_name());
	...
	private boolean saveOrUpdatePasswordInTable2(CustomerRegistrationBean userBean) {
